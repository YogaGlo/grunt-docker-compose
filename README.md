...
```shell
npm install grunt-docker-compose --save-dev
```
...
## The "docker_compose" task

### Overview
In your project's Gruntfile, add a section named `docker_compose` to the data object passed into `grunt.initConfig()`.
